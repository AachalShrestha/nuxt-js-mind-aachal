    ...
    <div class="pr-5">
      ...
      <div class="info flex flex-col items-center justify-center h-screen">
        <div class="container text-left p-1 lg:p-20">
          <div class="container  animate-fade animate-once animate-delay-[100ms] p-10 lg:p-20 absolute top-8">
            <div class="text-9xl font-bold animate-fade-down animate-once">{{ settings.homepage_title }}</div>
            <div class="text-l ">{{ settings.homepage_subtitle }}</div>
            ...
            <div class="flex mt-10">
                <NuxtLink to="https://github.com/bureaupixel/" target="_blank">
                    ...
                    <div 
      class="h-full delay-[300ms] duration-[600ms] taos:translate-y-[100%] taos:invisible" data-taos-offset="300"
